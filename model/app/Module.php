...
class Module extends OBase{
  function __construct(){
    ...
    $model = array(
        ...
        'enables'          => array('type'=>Base::TEXT,    'len'=>100, 'com'=>'Lista de habilidades que tener el módulo permite'),
        ...
        'storage'          => array('type'=>Base::TEXT,    'len'=>200, 'com'=>'Recursos almacenados'),

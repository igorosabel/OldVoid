...
class Ship extends OBase{
  function __construct(){
    ...
    $model = array(
        ...
        'original_name'           => array('type'=>Base::TEXT,    'len'=>50, 'com'=>'Nombre original de la nave'),
        'name'                    => array('type'=>Base::TEXT,    'len'=>50, 'com'=>'Nombre de la nave'),
        ...
        'gun_ports'               => array('type'=>Base::NUM,                'com'=>'Número de huecos para introducir armas'),
  ...
  private $guns          = array();
  private $modules_small = array();
  private $modules_big   = array();

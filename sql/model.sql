...
CREATE TABLE `planet` (
  ...
  `rotation` int(11) NOT NULL COMMENT 'Velocidad de rotación del planeta alrededor de la estrella' ,
  `survival` int(11) NOT NULL COMMENT 'Indice de supervivencia' ,
  ...
  `explored` tinyint(1) NOT NULL COMMENT 'Indica si el planeta ya ha sido explorado por alguien' ,
  `explore_time` int(11) NOT NULL COMMENT 'Tiempo, en segundos, necesarios para explorar el planeta' ,
  `created_at` datetime NOT NULL COMMENT 'Fecha de creación del registro' ,
  `updated_at` datetime NOT NULL COMMENT 'Fecha de última modificación del registro' ,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci ;
...
CREATE TABLE `moon` (
  ...
  `explored` tinyint(1) NOT NULL COMMENT 'Indica si la luna ya ha sido explorada por alguien' ,
  `explore_time` int(11) NOT NULL COMMENT 'Tiempo, en segundos, necesarios para explorar la luna' ,
  `created_at` datetime NOT NULL COMMENT 'Fecha de creación del registro' ,
  `updated_at` datetime NOT NULL COMMENT 'Fecha de última modificación del registro' ,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci ;
...
CREATE TABLE `module` (
  ...
  `storage_capacity` int(11) NOT NULL COMMENT 'Capacidad de almacenamiento del módulo' ,
  `storage` varchar(200) COLLATE utf8_unicode_ci NOT NULL COMMENT 'Recursos almacenados' ,
...
CREATE TABLE `npc` (
  ...
  `hulls_start` varchar(200) COLLATE utf8_unicode_ci NOT NULL COMMENT 'Hulls que tiene a la venta por defecto' ,
  `hulls_actual` varchar(200) COLLATE utf8_unicode_ci NOT NULL COMMENT 'Hulls que tiene actualmente a la venta' ,
  `shields_start` varchar(200) COLLATE utf8_unicode_ci NOT NULL COMMENT 'Shields que tiene a la venta por defecto' ,
  `shields_actual` varchar(200) COLLATE utf8_unicode_ci NOT NULL COMMENT 'Shields que tiene actualmente a la venta' ,
  `engines_start` varchar(200) COLLATE utf8_unicode_ci NOT NULL COMMENT 'Engines que tiene a la venta por defecto' ,
  `engines_actual` varchar(200) COLLATE utf8_unicode_ci NOT NULL COMMENT 'Engines que tiene actualmente a la venta' ,
  `generators_start` varchar(200) COLLATE utf8_unicode_ci NOT NULL COMMENT 'Generators que tiene a la venta por defecto' ,
  `generators_actual` varchar(200) COLLATE utf8_unicode_ci NOT NULL COMMENT 'Generators que tiene actualmente a la venta' ,
...
CREATE TABLE `resources` (
  ...
  `value` int(11) NOT NULL COMMENT 'Cantidad de recursos que hay' ,
  `created_at` datetime NOT NULL COMMENT 'Fecha de creación del registro' ,
  `updated_at` datetime NOT NULL COMMENT 'Fecha de última modificación del registro' ,

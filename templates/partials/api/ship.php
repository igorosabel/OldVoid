...
<?php $s = $values['ship']; ?>
{
  ...
  "shield_type_name": "<?php echo urlencode(Ship::getShieldTypeName($s->get('shield_id_type'))) ?>",
  ...
  "engine_type_name": "<?php echo urlencode(Ship::getEngineTypeName($s->get('engine_id_type'))) ?>",
  ...
  "generator_type_name": "<?php echo urlencode(Ship::getGeneratorTypeName($s->get('generator_id_type'))) ?>",
...
<?php foreach ($s->getGuns() as $i => $gun): ?>
    {
      ...
      "gun_type_name": "<?php echo urlencode(Ship::getGunTypeName($gun->get('id_type'))) ?>",
      "strength": <?php echo $gun->get('strength') ?>,
      "accuracy": <?php echo $gun->get('accuracy') ?>,
      "recharge_time": <?php echo $gun->get('recharge_time') ?>,
      "ignores_shields": <?php echo $gun->get('ignores_shields') ?>,
  ...
  <?php foreach ($s->getModulesSmall() as $i => $module): ?>
    {
      ...
      "module_type_name": "<?php echo urlencode(Ship::getModuleTypeName($module->get('id_type'))) ?>",
      ...
      <?php foreach ($module_enables as $j=>$enable): ?>
          {
            "id": "<?php echo $enable ?>",
            "enable_name": "<?php echo urlencode(Ship::getModuleEnableName($enable)) ?>"
